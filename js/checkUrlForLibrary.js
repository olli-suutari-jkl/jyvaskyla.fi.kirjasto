...
function asyncCheckUrlForKeskiLibrary() {
    ...
    setTimeout(function() {
        ...
        // ?%2525253f | Such strings are generated by bugged Drupal from multiple ? such as ?library?service. Debug!
        if(urlUnescapeSpaces.indexOf('jyvaskyla.fi') > -1) {
            console.log(urlUnescapeSpaces);
            if(urlUnescapeSpaces.indexOf('%%25253f') > -1) {
                console.log("%%25253f");
                urlUnescapeSpaces = urlUnescapeSpaces.replace('%25253f', '');
            }
            else if(urlUnescapeSpaces.indexOf('%2525253f') > -1) {
                urlUnescapeSpaces = urlUnescapeSpaces.replace('%%2525253f', '');
                console.log("%2525253f");
            }
            console.log(urlUnescapeSpaces)
        }
        if(!matchFound) {
