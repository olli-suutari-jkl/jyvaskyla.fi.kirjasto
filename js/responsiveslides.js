	...
	$.fn.responsiveSlides = function (options) {
		...
		return this.each(function () {
			...
			if ($slide.length > 1) {
				...
				// Navigation
				var progressBar =
					'<div class="slider-play-container"> <button title="' +
					i18n.get('Stop automatic playback') +
				...
				var navMarkup =
					...
					'<button title="' +
					i18n.get('Previous slide') +
					'" data-placement="bottom" ' +
					'data-toggle="navigation-tooltip" id="sliderPrevious" ' +
					'class="slider-btn ' +
					navClass +
					' prev"><i aria-hidden="true" class="fas fa-arrow-left"></i></button>' +
					'<i class="slider-counter"><span id="currentSlide">1</span></i>' +
					'<button title="' +
					i18n.get('Next slide') +
					'" data-placement="right" data-toggle="navigation-tooltip" ' +
					'id="sliderForward" class="slider-btn ' +
					navClass +
